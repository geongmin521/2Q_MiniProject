...
Shop::Shop() 
{
	...
	Music::soundManager->PlayMusic(Music::eSoundList::Lock, Music::eSoundChannel::Effect); }, ButtonType::Active).setPos_Parent({ LPad + i * 480, 130 }, child->transform); //매커니즘이 좀다른데.. 아예 다른걸로 만들까? 똑같이 하면되는데 그냥 온클릭에서 처리할까? 
