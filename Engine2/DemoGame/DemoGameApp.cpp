...
void DemoGameApp::Initialize(HINSTANCE hInstance, int nShowCmd)
{
	...
	Music::soundManager->GetInstance()->LoadMusic(Music::eSoundList::DefDestroy, false , "../Data/Sound/Enemy/DefDestroy.wav");		// EnemyHitted
	...
	Music::soundManager->GetInstance()->LoadMusic(Music::eSoundList::ArrowAttack, false, "../Data/Sound/Tower/ArrowAttack.mp3");	// TowerAttack
    ...
    Music::soundManager->GetInstance()->LoadMusic(Music::eSoundList::HolyHeal, false, "../Data/Sound/Tower/Heal.mp3");	            // TowerAttack
	Music::soundManager->GetInstance()->LoadMusic(Music::eSoundList::ArrowEffect, false, "../Data/Sound/Tower/ArrowEffect.mp3");	// TowerEffect
